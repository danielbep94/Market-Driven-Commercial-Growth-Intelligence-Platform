...
# Phase 1 — Data Profiling: FORECAST
...
SOURCE_TABLE = f"MGI_{'{'}ENVIRONMENT.upper(){'}'}.BRONZE.FORECAST_RAW"
DATE_COL     = "forecast_week"
UK_COLS      = "sku_id,channel_id,forecast_week".split(",")
...
# 9. Write output to docs/phase_outputs/phase1_data_inventory.md (append FORECAST section)
