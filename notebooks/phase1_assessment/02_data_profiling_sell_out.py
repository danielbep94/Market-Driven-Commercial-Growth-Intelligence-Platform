...
# Phase 1 — Data Profiling: SELL_OUT
...
# COMMAND ----------
ENVIRONMENT  = "dev"
SOURCE_NAME  = "SELL_OUT"
SOURCE_TABLE = f"MGI_{'{'}ENVIRONMENT.upper(){'}'}.BRONZE.SELL_OUT_RAW"
DATE_COL     = "sell_out_date"
UK_COLS      = "store_id,sku_id,sell_out_date".split(",")
...
# 9. Write output to docs/phase_outputs/phase1_data_inventory.md (append SELL_OUT section)
