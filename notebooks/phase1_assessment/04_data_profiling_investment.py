...
# Phase 1 — Data Profiling: INVESTMENT
...
SOURCE_TABLE = f"MGI_{'{'}ENVIRONMENT.upper(){'}'}.BRONZE.INVESTMENT_RAW"
DATE_COL     = "period_month"
UK_COLS      = "brand_id,channel_id,period_month".split(",")
...
# 9. Write output to docs/phase_outputs/phase1_data_inventory.md (append INVESTMENT section)
