...
ENVIRONMENT  = "dev"
SOURCE_NAME  = "PRICE"
SOURCE_TABLE = f"MGI_{'{'}ENVIRONMENT.upper(){'}'}.BRONZE.PRICE_RAW"
DATE_COL     = "price_date"
UK_COLS      = "sku_id,customer_id,price_date".split(",")
...
# 9. Write output to docs/phase_outputs/phase1_data_inventory.md (append PRICE section)
